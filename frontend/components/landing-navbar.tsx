    ...
    >
      <div className="container mx-auto px-8 h-full flex items-center">
        ...
        <div className="flex items-center space-x-8 ml-auto">
          ...
          <Link href="/login">
            <Button variant="outline" className="border-gray-300 text-gray-700 hover:text-blue-600 hover:border-blue-500 px-7 py-2">
              Log in
            </Button>
          </Link>
          <Link href="/signup">
            <Button className="bg-gradient-to-r from-blue-600 to-sky-500 hover:from-blue-700 hover:to-sky-600 text-white shadow-lg shadow-blue-500/20 px-7 py-2">
              Get Started
            </Button>
          </Link>
        </div>
